            ...
            <div className="flex items-center gap-3">
                {user.is_admin && (
                    <button 
                        ...
                        disabled={isClearing}
                        className="flex items-center gap-2 bg-red-50 text-red-600 px-4 py-2 rounded-xl text-xs font-black uppercase tracking-tight hover:bg-red-100 transition-all border border-red-200 disabled:opacity-50"
                ...
                <div className="hidden md:flex items-center gap-2 bg-brand-50 px-3 py-1.5 rounded-lg border border-brand-100">
                    ...
                    <span className="text-xs font-bold text-brand-600 uppercase tracking-tighter">Supporto Moderato</span>
                </div>
            </div>
        </div>
        ...
        <div className="p-6 bg-white border-t border-gray-200">
            <form onSubmit={handleSendMessage} className="max-w-4xl mx-auto flex gap-4">
                <input 
                    ...
                    className="flex-1 bg-gray-50 border border-gray-200 rounded-2xl px-6 py-4 focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all text-gray-900 font-medium placeholder:text-gray-400"
