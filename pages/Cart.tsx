...
export const Cart: React.FC<CartProps> = ({ user }) => {
  ...
  if (items.length === 0) {
    return (
      <div className="pt-32 min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4 relative overflow-hidden">
        {/* Background Glows */}
        ...
        <div className="bg-white p-6 rounded-full mb-6 relative z-10 border border-gray-200">
          <ShoppingCart className="h-12 w-12 text-slate-500" />
        </div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2 relative z-10">Il tuo carrello è vuoto</h2>
        <p className="text-gray-500 mb-8 relative z-10">Sembra che tu non abbia ancora aggiunto nessun corso.</p>
        <button 
          onClick={() => navigate('/')}
  ...
  return (
    <div className="pt-32 min-h-screen bg-gray-50 pb-20 relative overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-brand-500/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-600/10 rounded-full blur-[120px]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-8 sticky top-32">
