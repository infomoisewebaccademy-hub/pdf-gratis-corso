        ...
        <div className="max-w-7xl mx-auto px-6 py-10 lg:px-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
              ...
              <button 
                ...
                className="flex items-center text-sm font-bold text-brand-600 bg-white border border-gray-200 hover:bg-gray-50 px-4 py-2.5 rounded-xl transition-all shadow-sm active:scale-95"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
                  <div className="text-gray-500 text-xs font-bold uppercase tracking-wider">Percorsi Attivi</div>
                  <div className="text-2xl font-black text-gray-900">{myCourses.length}</div>
              </div>
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
                  <div className="text-gray-500 text-xs font-bold uppercase tracking-wider">Completamento Medio</div>
          ...
          {myCourses.length === 0 ? (
              <div className="bg-white rounded-3xl shadow-sm p-16 text-center border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8">
                  {myCourses.map(course => {
                      ...
                      return (
                          <div key={course.id} className="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden flex flex-col group hover:shadow-xl transition-all duration-300 cursor-pointer" onClick={() => navigate(`/course/${course.id}`)}>
                              ...
                              <div className="p-8 flex-1 flex flex-col">
                                  ...
                                  <div className="flex justify-between text-sm text-gray-500 mb-8 border-t border-gray-100 pt-4">
