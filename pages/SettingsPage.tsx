                        ...
                        <form onSubmit={handlePasswordUpdate} className="space-y-4 max-w-sm">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="block w-full border border-gray-200 rounded-xl p-3.5 focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all"
                                    placeholder="••••••••"
                                    required
                                />
                            </div>
