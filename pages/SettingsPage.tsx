        ...
        <div className="pt-20 min-h-screen bg-white flex flex-col lg:flex-row relative overflow-hidden">
            ...
            <main className="flex-1 bg-gray-50/50 pb-20 relative z-10">
                <div className="max-w-4xl mx-auto px-6 py-10 lg:px-12">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900 mb-6 tracking-tight">Impostazioni Account</h1>
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">Modifica Password</h2>
                        ...
                        <form onSubmit={handlePasswordUpdate} className="space-y-4 max-w-sm">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="block w-full bg-gray-50 border border-gray-200 rounded-xl p-3.5 focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500 outline-none transition-all text-gray-900 placeholder:text-gray-400"
                                    placeholder="••••••••"
                                    required
                                />
                            </div>
